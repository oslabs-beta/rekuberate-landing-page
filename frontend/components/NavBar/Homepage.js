      ...
      <div className='key-features'>
        ...
        <div className='Pods-demo'>
          <div className='Pods-description'>
            Displaying an aesthic GUI that allows the user to interact with their cluster and view their cluster health
            real-time. Color variations allowing the user to see current pods that active, pending or down
          </div>
          <div>
        ...
        <div className='metrics'>
          ...
          <div className='metrics-description'>
            Displaying a real-time grafana rendered graphs illustrating the unique local health metrices of your
